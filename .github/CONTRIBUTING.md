...
[create a ticket](https://github.com/kevalpatel2106/green-build/issues/new). No idea is bad, no opinion is wrong. 
...
```groovy
git clone https://github.com/kevalpatel2106/green-build.git && cd Stand-Up
```
