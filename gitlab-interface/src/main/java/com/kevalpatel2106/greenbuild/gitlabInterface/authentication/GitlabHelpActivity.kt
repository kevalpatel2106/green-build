...
import kotlinx.android.synthetic.main.activity_gitlab_help.*


class GitlabHelpActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_gitlab_help)
    ...
    companion object {
        ...
        fun launch(context: Context, profileUrl: String?) {
            context.startActivity(Intent(context, GitlabHelpActivity::class.java).apply {
